  ...
  function atClosingBrace(code) {
    ...
    if (spread && estree) {
      ...
      if (head.expression.properties[1]) {
        throw new VFileMessage(
          'Unexpected extra content in spread: only a single spread is supported', // @ts-expect-error Looks similar enough.
        ...
        throw new VFileMessage(
          'Unexpected `' +
            ...
            '` in code: only spread elements are supported', // @ts-expect-error Looks similar enough.
