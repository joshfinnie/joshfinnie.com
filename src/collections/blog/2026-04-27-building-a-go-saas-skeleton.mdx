---
title: "What I Put in Every Go SaaS Before Writing a Single Feature"
date: "2026-04-27"
tags:
  - "go"
  - "saas"
...
unsplashURL: "ansiep"
draft: false
slug: "building-a-go-saas-skeleton"
---
...
I built [kairgos](https://github.com/joshfinnie/kairgos) to solve that. It's a Go skeleton with the infrastructure decisions already made, so the next project starts on the product, not the scaffolding. Here's what I put in it and why.

## The Router and Middleware Stack

I chose [Chi](https://github.com/go-chi/chi) for routing. It's idiomatic Go, composes cleanly with standard `http.Handler`, and has no opinions about your project structure. Frameworks that come with their own conventions are fine until they're not. Chi stays out of the way.
...
I use [Uber Zap](https://github.com/uber-go/zap) for logging. In dev mode it outputs human-readable JSON. In production it outputs structured JSON. The request logging middleware attaches the request ID, method, path, status code, and latency to every log line. Any of these can be filtered in a log aggregator without parsing strings.
...
If you're starting an AI SaaS in Go, this is the floor I'd build from. Find me on [**Bluesky**](https://bsky.app/profile/joshfinnie.dev) if you have questions or strong opinions about what else belongs in here.
