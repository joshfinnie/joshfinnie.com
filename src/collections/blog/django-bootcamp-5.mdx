...
- **REST API with Django REST Framework** — Turn your bookmark manager into an API that mobile apps or browser extensions can use. [Django REST Framework](https://www.django-rest-framework.org/) makes this surprisingly easy.
