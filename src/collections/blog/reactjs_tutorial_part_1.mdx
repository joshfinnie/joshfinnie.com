...
import helloExpress from "@assets/blog/hello-express.png";
import helloReact from "@assets/blog/hello-react.png";
...
<img src={helloExpress.src} alt="Hello Express.js" />
...
<img src={helloReact.src} alt="hello react" />
