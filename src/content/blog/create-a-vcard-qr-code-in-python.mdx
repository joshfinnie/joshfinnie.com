...
Also notice, I have went from a pure textfile to python using [f-strings](https://docs.python.org/3/tutorial/inputoutput.html#tut-f-strings).
...
QR codes allow for some of the image to be covered up for redundacy.
...
<div class="flex justify-center items-center">
  <Image src={qr2} alt="" width="515" />
</div>

## Conclusion

This was a very fun experiment into the inner workings of Python, the `qrcode` package and image manipulation with Pillow. I hope you enjoy and please share your QR codes with me on [Threads](https://threads.net/@joshfinnie).
