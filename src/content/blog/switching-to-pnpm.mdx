...
Use it as my Node.js version manager.
Use it as my default package manager.
Use it to install NPM when needing NPM for some old projects.
...
First, we need to entirely remove NVM.
Running the following commands did this for me:

```
$ npm uninstall -g pnpm

removed 1 package in 252ms
$ rm -rf "$NVM_DIR"
...
And these are the steps I needed.
Bash or Zsh you need to remove the below lines from your rc file:
